...
public class LossGoodsActivity extends BaseActivity implements View.OnClickListener, BaseRefreshListener, AdapterView.OnItemClickListener{
    ...
    public void initBundle(Bundle bundle) {
        ...
        custId = (String) SPUtils.get(LossGoodsActivity.this, Constants.CUST_ID, "");
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_loss_goods;
    }
    ...
    private void getData(String page, String rows,String search) {
        ...
        showLoadDialog();
        OkhttpUtil.okHttpPost(ApiManage.getLossProductList(), paramsMap, new CallBackUtil.CallBackString() {
            @Override
            public void onFailure(Call call, Exception e) {
                ToastUtils.showToast(LossGoodsActivity.this, R.string.error, 2000);
                hideLoadDialog();
            }
            ...
            public void onResponse(String response) {
                ...
                if ("200".equals(entity.getCode())) {
                    ...
                    ToastUtils.showToast(LossGoodsActivity.this, entity.getMsg(), 2000);
                }
                hideLoadDialog();
            }
        });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (listDatas.get(position).getStockNum()<=0){
            ToastUtils.showToast(LossGoodsActivity.this, "商品对应编码库存不足无法创建订单", 2000);
        }else {

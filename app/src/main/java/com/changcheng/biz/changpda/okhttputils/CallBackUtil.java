package com.changcheng.biz.changpda.okhttputils;
...
public abstract class CallBackUtil<T> {
    ...
    public static abstract class CallBackBean<T> extends CallBackUtil<T>{
        // 要解析的JavaBean的class。
        Class<T> mClass;
        public CallBackBean(Class mClass) {
            this.mClass = mClass;
        }
        @Override
        public T onParseResponse(Call call, Response response) {
            try {
                ...
                if ("200".equals(code)){
                    ...
                    return JSONObject.parseObject(user.toString(), mClass);

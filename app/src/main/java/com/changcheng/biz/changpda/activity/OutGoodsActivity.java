...
public class OutGoodsActivity extends BaseActivity implements View.OnClickListener, BaseRefreshListener, AdapterView.OnItemClickListener{
    ...
    public void initBundle(Bundle bundle) {
        ...
        custId = (String) SPUtils.get(OutGoodsActivity.this, Constants.CUST_ID, "");
    ...
    public void initData(Context mContext) {
        ...
        adapter = new CommonAdapter<GoodsEntity.DataBean.RowsBean>(OutGoodsActivity.this, R.layout.item_goods_lv, listDatas) {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_next:
                ...
                bundle.putString(Constants.FROM, "OutGoods");
                ...
                if (selectDatas.size() > 0) {
                    ...
                    ToastUtils.showToast(OutGoodsActivity.this, "请选择商品", 2000);
                }
    ...
    private void getData(String page, String rows,String search) {
        ...
        showLoadDialog();
        OkhttpUtil.okHttpPost(ApiManage.getNotOutTreasuryList(), paramsMap, new CallBackUtil.CallBackString() {
            @Override
            public void onFailure(Call call, Exception e) {
                ToastUtils.showToast(OutGoodsActivity.this, R.string.error, 2000);
                hideLoadDialog();
            }
            ...
            public void onResponse(String response) {
                ...
                if ("200".equals(entity.getCode())) {
                    ...
                    ToastUtils.showToast(OutGoodsActivity.this, entity.getMsg(), 2000);
                }
                hideLoadDialog();
            }
        });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (listDatas.get(position).getStockNum()<=0){
            ToastUtils.showToast(OutGoodsActivity.this, "商品对应编码库存不足无法创建订单", 2000);
        }else {
